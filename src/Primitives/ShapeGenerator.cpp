...
ShapeData ShapeGenerator::makeCube() {
	...
	Vertex stackVerts[] = 
	{
		...
		vec3(+0.0f, +0.0f, -1.0f),  // Normal
		vec3(+1.0f, 0.0f, -1.0f),  // 6
		vec3(-1.0f, -1.0f, -1.0f),  // 7
		vec3(+0.3f, +1.0f, +0.5f),  // Color
		vec3(+0.0f, +0.0f, -1.0f),  // Normal
		vec3(0.0f, 0.0f, -1.0f),  // 7
...
void ShapeGenerator::generatePatches(float * v, float * n, float * tc, uint* el, int grid) {
